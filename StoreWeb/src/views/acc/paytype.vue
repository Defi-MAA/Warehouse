<template>
  <ContentWrap>
    ...
    <el-table :data="tableData" @sort-change="handleSortChange" :default-sort="{
      ...
      <el-table-column align="center" prop="code" label="项目编码" :sortable="'custom'" width="150px">
      </el-table-column>
      <el-table-column align="center" prop="name" label="项目名称" :sortable="'custom'" width="150px">
      </el-table-column>
      <el-table-column align="center" prop="category" label="项目类别" :sortable="'custom'" width="150px">
      </el-table-column>
      <el-table-column align="center" prop="status" label="项目状态" :sortable="'custom'" width="150px">
        <template #default="{ row }">
          <el-checkbox v-model="row.status" onclick="return false; "></el-checkbox>
        </template>
      </el-table-column>
      <el-table-column align="center" prop="a_no" label="总帐科目" :sortable="'custom'" width="150px">
      </el-table-column>
      ...
      <el-table-column align="center" prop="f_no" label="外币编号" :sortable="'custom'" width="150px">
      </el-table-column>
  ...
  <Dialog v-model="dialogVisible" :title="dialogTitle">
    <el-form :model="form" label-width="auto" ref="ruleFormRef" :rules="rules">
      <el-row :gutter="10">
        <el-col :span="12">
          <el-form-item label="项目编码" prop="ivcost">

            <el-input v-model="form.code"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="项目名称" prop="ivdept">

            <el-input v-model="form.name"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="项目类别" prop="ivitem">

            <el-select v-model="form.category" placeholder="请选择">
              <el-option label="应付挂帐" value="0">
              </el-option>
              <el-option label="应付结算" value="1">
              </el-option>
        ...
        <el-col :span="12">
          <el-form-item label="项目状态" prop="ivitem">
        ...
        <el-col :span="12">
          <el-form-item label="会计科目" prop="a_no">
            ...
            <el-cascader v-model="form.ano" :options="treeitem" filterable :show-all-levels="false" :props="{ expandTrigger: 'hover' }">
            </el-cascader>
          </el-form-item>
        </el-col>
        ...
        <el-col :span="12">
          <el-form-item label="外币编号" prop="ivdept">
        ...
        <el-col :span="12">
          <el-form-item label="备注" prop="ivdept">
...
const getList = async () => {
  ...
  const res = await request.post({ url: '/api/apitem/selectApitemPage', data })
...
const searchSchema = reactive<FormSchema[]>([
  ...
  //   component: 'Select',
  //   optionApi: async () => {
  //     let data = typeids.value.map((v: any) => ({
  //       label: v.name,
  //       value: '' + v.id
  //     }))
  //     return data
...
const editData = async (row: any) => {
  ...
  const res = await request.post({ url: '/api/apitem/getApitem', data: { code: row.code } })
  ...
  await formEl.validate(async (valid) => {
    if (valid) {
      ...
      if (formData) {
        ...
        const res = await request.post({
          url: actionType.value === 'edit' ? '/api/apitem/updateApitem' : '/api/apitem/insertApitem',
          data: formData
        }).catch(() => {
