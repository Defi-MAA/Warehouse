            ...
            <el-container style="width: 100%;">
                <el-header>
                    ...
                    <el-row>
                        ...
                        <div style="display:inline-block;">
                            <label class="radio-label" style="padding-left:10px;">移出仓库</label>
                        ...
                        <div style="display:inline-block;">
                            <label class="radio-label" style="padding-left:10px;">移入仓库</label>
                ...
                <el-main>
                    <el-table v-loading="listLoading1" :data="items" :border="true" fit highlight-current-row
                        ...
                        <el-table-column prop="amt" label="金额" width="120px">
                            <template #default="{ row }">
                                <el-input v-model="row.amt" readonly type="number" @focus="focus($event)"
                                    placeholder="" />
                            </template>
                        </el-table-column>
