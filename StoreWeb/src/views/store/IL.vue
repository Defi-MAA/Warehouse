            ...
            <el-container style="width: 100%;">
                <el-header>
                    ...
                    <el-row>
                        ...
                        <div style="display:inline-block;">
                            <label class="radio-label" style="padding-left:10px;">报损类型</label>
                            <el-select style="width: 120px; " clearable v-model="form.DiscardType" placeholder="请选择">
                                <el-option v-for="(item, index) in DiscardTypes" :key="index" :label="item.name"
                                    :value="item.code">
                                </el-option>
                            </el-select>
                        </div>
