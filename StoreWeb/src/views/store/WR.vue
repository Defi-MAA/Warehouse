            ...
            <el-container style="width: 100%;">
                    ...
                    <el-row>
                        ...
                        <div style="display:inline-block;">
                            ...
                            <el-select v-model="form.apitem" style="width: 120px; " placeholder="请选择">
                                <el-option v-for="(item, index) in settlelist" :key="index" :label="item.name"
                                    :value="item.code">
                                </el-option>
                            </el-select>
                        </div>
                    ...
                    <el-row>
                        ...
                        <div style="display:inline-block;">
                            ...
                            <el-select style="width: 120px; " v-model="form.vndr" placeholder="请选择">
                                <el-option v-for="(item, index) in custlist" :key="index" :label="item.name"
                                    :value="item.code">
                                </el-option>
                            </el-select>
                        </div>
                ...
                <el-main>
                    <el-table v-loading="listLoading1" :data="items" :border="true" fit highlight-current-row
                        ...
                        <el-table-column prop="lot" label="批次" width="200px">
                            <template #default="{ row }">
