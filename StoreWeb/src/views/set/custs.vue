<template>
	<ContentWrap>
		...
		<div style="border-bottom: 1px solid #e4e7ed;">
			<Search  show-expand expand-field="cisdtl" :schema="searchSchema" @reset="setSearchParams" @search="setSearchParams" />
		</div>
		...
		<el-table :data="tableData" @sort-change="handleSortChange" :default-sort="{
			...
			<el-table-column align="center" prop="ccode" label="供应商编码" sortable="custom"  width="150px">
			</el-table-column>
			<el-table-column align="center" prop="cname" label="供应商名称" sortable="custom"  width="150px">
			</el-table-column>
			...
			<el-table-column align="center" prop="caddress" label="地址" width="150px">
			</el-table-column>
			...
			<el-table-column align="center" prop="cmodpsn" label="修改人" sortable="custom"  width="150px">
			</el-table-column>
	...
	<Dialog v-model="dialogVisible" :title="dialogTitle" width="1100px">
		<el-form :model="form" label-width="auto" ref="ruleFormRef" :rules="rules">
			<el-row :gutter="10">
				...
				<el-col :span="6">
					<el-form-item label="供应商编码" prop="ccode">
				...
				<el-col :span="6">
					<el-form-item label="信用额度" prop="ccredit">
				...
				<el-col :span="6">
					<el-form-item label="供应商类别" prop="ccategory">
				...
				<!-- <el-col :span="6">
					<el-form-item label="标志" prop="minqty">
						<el-input v-model="form.cflag"></el-input>
					</el-form-item>
				</el-col> -->
				<el-col :span="6">
				...
				<el-col :span="6">
					<el-form-item label="供应商类型" prop="ccusttype">
...
const initData = async () => {
	let res = await request.post({ url: '/api/cust/getTClass', data: {cclas: '1'} })
