	...
	<view>
		...
		<form>
			<view class="cu-form-group ">
				...
				<text style="width: 100%;">{{info.addtime}}</text>
...
<!-- 				<view class=" padding-sm  solid-right text-center" style="width: 15%;">金额</view> -->
			...
			<view class=" flex solid-bottom justify-start " v-for="(item,index) in items">
				...
				<view class=" padding-sm  solid-right text-center" style="width: 25%;">
					{{item.name}}/{{item.size}}
				</view>
